...
\\
f_n&= n\frac v{2L}=nf_1&n&\in \mathbb{Z}^+\\
\hline\\
L&= \text{Length}\\
...
## Pipes
These occur inside of all wind instruments, and is what allows them to make sounds. These are in two forms, either open pipes with both ends open, or closed pipes where one end is capped.
>[!Note]
...
f_n&= \frac{nV}{2L}\\
\hline\\
f_n&= \text{nth Harmonic Frequency}\\
n&\in I\\
L&= \text{Pipe Length}\\
