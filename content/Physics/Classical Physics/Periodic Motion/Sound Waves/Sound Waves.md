...
## Attack and Decay
This is the start and the end of the tone, and it plays another role in the sounds made. 
## Noise
This is the summation of all the sounds we hear, and not just necessarily the sounds that are coming from the musical instrument. 
## Nodes and Antinodes
For sound waves, there are two different subsets of nodes: pressure nodes and displacement nodes. Pressure nodes are where the pressure is invariant, and displacement nodes are where the displacement is invariant. These two different kinds of nodes will occur at the antinode of the other. 
