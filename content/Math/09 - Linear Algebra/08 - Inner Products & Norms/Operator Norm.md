...
\end{aligned}
$$
This is the [[Matrix]] analog of the [[Euclidean Norm|Euclidian Norm]] for  a [[Vector]]. Some properties of the operator norm are:
1. $$
\begin{aligned}
||A||&= \max_{||x||=1}||Ax||
\end{aligned}
...
\end{aligned}
$$
Where $D$ is defined to be a [[Diagonal Matrix]]
