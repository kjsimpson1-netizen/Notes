The [Condition Number](Condition Number) describes how sensitive the final solution of a problem is to small perturbations in the initial conditions. For a [Matrix](Matrix.md) $A$, this is denoted by $\text{cond}(A)$ and is given by:
