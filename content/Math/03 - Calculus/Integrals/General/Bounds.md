On an integral, there is an upper and a lower bound. This appears on the upper and the lower portions of the symbol for [[Integral]]. For example, $\int_a^b$ "$a$" is the lower bound here and "$b$" is the upper bound, therefore we must integrate between a and b. 
>[!Note]
