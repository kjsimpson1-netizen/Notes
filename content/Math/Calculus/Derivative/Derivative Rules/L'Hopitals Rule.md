...
2. Both numerator and denominator must be differentiable
3. [[Derivative]] of denominator is nonzero
...
This works because even though both of the functions can approach either $\infty$ or $0$ as a limit, they're rates of change up till that point could be vastly different, and therefore taking the ratio of the two derivatives can show us the value that it approaches.