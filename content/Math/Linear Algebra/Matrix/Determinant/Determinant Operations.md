 Whenever there is a [[Gaussian Elimination]] done on a [[Matrix]], the determinant will change by a value depending upon the operation performed.
## Adding Rows/Columns
If there is one row or column of the [[Matrix]] that is added or subtracted from another, the [[Determinant]] remains the same
## Scalar Multiple
...
>[!Note]
>The [[Transposition]] of a [[Determinant]] will be the same as the original [[Determinant]]. 