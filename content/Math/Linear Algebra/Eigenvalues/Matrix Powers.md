$$
If we want to raise a [[Matrix]] to a power, we can easily do this if the vector that it's being multiplied by is one of it's [[Eigenvalues|Eigenvectors]]. $$\begin{aligned}
...
\end{aligned}$$From this point, we can expand and simplify as necessary. 
$$
>[!Note]
