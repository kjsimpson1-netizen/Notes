...
\end{aligned}
$$
From here, we have that the two derivatives are all equal to a constant, and a [[Sturm-Liouville]], since the equation above states that the rate of change in space is independent of time, and thus a constant. Therefore, we can choose our eigenvalue:
$$
\begin{aligned}
