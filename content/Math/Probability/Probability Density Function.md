...
From this we can also see that the value of $f(x)$ can be greater than 1, however just not on a range for which the integral is greater than 1. 
Also, if we are given the [[Cumulative Density Function]], we can find the probability density function by taking the derivative. 