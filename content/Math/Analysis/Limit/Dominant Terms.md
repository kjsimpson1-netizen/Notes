...
&= \frac72
\end{aligned}$$For these ones, whichever one has a much higher degree will dominate and therefore the value of $f(x)$ will approach whichever the dominant term leans towards.
$$
## Exponentials
$$
$$\begin{aligned}
