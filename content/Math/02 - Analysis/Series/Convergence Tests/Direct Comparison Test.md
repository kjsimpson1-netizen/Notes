## Integrals
This is another test to see if the [[Improper Integral]] due to a [[Singular Point]] using the [[Cauchy Principal Value]] will converge or diverge. The general rule for this is that for any function with [[Continuity]], with $a=-\infty$ and/or $b=+\infty$, and letting the following being true:
$$
\begin{aligned}
