These are [[Series]] where each following term is a constant multiple of the previous term, and we can represent this as:
$$
\begin{aligned}
\sum_{n=0}^\infty ar^n
\end{aligned}
...
## Closed Interval
If the series takes place on a finite interval, the [[Series]] can be calculated by:
$$
\begin{aligned}
